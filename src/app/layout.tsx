  ...
  return (
    <html lang="en" suppressHydrationWarning>
      <head>
        ...
        <link rel="icon" type="image/png" sizes="32x32" href="/favicon_io fretumfreight/favicon-32x32.png" />
        <link rel="icon" type="image/png" sizes="16x16" href="/favicon_io fretumfreight/favicon-16x16.png" />
        <link rel="shortcut icon" href="/favicon_io fretumfreight/favicon.ico" />
        <link rel="apple-touch-icon" sizes="180x180" href="/favicon_io fretumfreight/apple-touch-icon.png" />
        <link rel="manifest" href="/favicon_io fretumfreight/site.webmanifest" />
