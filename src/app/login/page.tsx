...
import { Chrome, KeyRound, Mail, Eye, EyeOff, ArrowRight, Shield, Zap, Users, AlertCircle } from "lucide-react"
...
export default function LoginPage() {
  ...
  const { signIn, signInGoogle, isAuthenticated, loading: authLoading, isConfigured } = useAuth()
